...
class StartShiftCommandSpec {
    ...
    fun `invoke() - retrieves location and makes call to shiftRepository`() {
        ...
        coEvery { shiftRepository.startShiftAsync("2019-03-31T19:25:59+11:00", "-33.881399", "151.199564") } returns Unit
    ...
    fun `invoke() uses default location if Location unavailable`() {
        ...
        //and starting a shift will succeed
        coEvery { shiftRepository.startShiftAsync("2019-03-31T19:25:59+11:00", "0.0", "0.0") } returns Unit
